...
const ProductPage = () => {
  ...
  const fetchProduct = async () => {
    try {
      ...
      alert("An error has occurred in fetchProduct: ", error);
    }
  };
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="specifications">
                <div className="spec">
                  <h2 className="spec__titl">Weight</h2>
                  <div className="spec__detail">{selectedProduct?.weight}</div>
                </div>
                <div className="spec">
                  <h2 className="spec__titl">Texture</h2>
                  <div className="spec__detail">{selectedProduct?.texture}</div>
                </div>
                <div className="spec">
                  <h2 className="spec__titl">Size</h2>
                  <div className="spec__detail">{selectedProduct?.size}</div>
                </div>
              </div>{" "}
            </>
          )}
